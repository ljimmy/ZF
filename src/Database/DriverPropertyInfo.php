...
class DriverPropertyInfo
{
    ...
    public function __construct(string $dsn, string $username = null, string $password = null, int $minConnections = 0, int $maxConnections = 0, array $options = [])
    {
